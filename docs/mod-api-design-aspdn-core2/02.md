...
![A459256_1_En_2_Fig1_HTML.jpg](A459256_1_En_2_Fig1_HTML.jpg)
...
如前所述，MVC 是 ASP.NET 核心支持的应用程序框架的一个例子。鉴于开放式架构设计的本质，它还允许您创建自己的应用框架，可以在 ASP.NET 核心上无缝运行。

## ASP.NET 核心可用的工具

图 [2-2](#Fig2) 显示了微软堆栈中 ASP.NET 核心可用工具的概述。

![A459256_1_En_2_Fig2_HTML.jpg](A459256_1_En_2_Fig2_HTML.jpg)
...
图中的下一个是。NET 核心命令行界面(CLI)，这是一个新的跨平台工具链，用于创建跨平台。NET 应用程序。它为任何终端界面带来了大部分工具特性，无论是 Windows 上的命令提示符或 PowerShell，还是 Linux 和 Mac 上的 Bash。
...
![A459256_1_En_2_Fig3_HTML.jpg](A459256_1_En_2_Fig3_HTML.jpg)
...
![A459256_1_En_2_Fig4_HTML.jpg](A459256_1_En_2_Fig4_HTML.jpg)
...
![A459256_1_En_2_Fig5_HTML.jpg](A459256_1_En_2_Fig5_HTML.jpg)
...
![A459256_1_En_2_Fig6_HTML.jpg](A459256_1_En_2_Fig6_HTML.jpg)
...
![A459256_1_En_2_Fig7_HTML.jpg](A459256_1_En_2_Fig7_HTML.jpg)
