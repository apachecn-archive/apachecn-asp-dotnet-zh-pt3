...
![9781430249771_Fig04-01.jpg](images/9781430249771_Fig04-01.jpg)
...
1.  通过从 File ![image](images/arrow.jpg) New 菜单中选择 Project，在`src`文件夹中创建一个新的解决方案文件。
2.  在已安装的![image](images/arrow.jpg)其他项目类型![image](images/arrow.jpg) Visual Studio 解决方案部分下，选择空白解决方案。
...
![9781430249771_Fig04-02.jpg](images/9781430249771_Fig04-02.jpg)
...
| SQL Server 数据库项目(这个可以在其他语言下找到![image](images/arrow.jpg) SQL Server。) | `MVC4ServicesDb` |
...
以后您可能需要添加更多的库，但这是一个好的开始，您可以在几乎任何 MVC 4 Web API 应用程序上安全地做这件事。
...
![9781430249771_Fig04-03.jpg](images/9781430249771_Fig04-03.jpg)
...
![image](images/sq.jpg) **注意**延迟加载告诉 NHibernate 只在需要的时候获取相关数据——而不是预先获取所有数据。例如，当从数据库中获取一个`Task`对象时，延迟加载意味着在执行需要这些值的代码之前，不会获取`Task`对象的赋值和类别。
...
![9781430249771_Fig04-04.jpg](images/9781430249771_Fig04-04.jpg)
